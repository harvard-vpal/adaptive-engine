...
datadir='/Users/ilr548/Dropbox/BKT/SME_interfacing'

writedir='/Users/ilr548/Dropbox/BKT/SME_interfacing/tagging_data'
...
##Things that involve the list of users, just for the sake of being able to run a simulaton
